    ...
    <div className="fixed bg-white w-full grid grid-flow-col p-4 border-b border-gray-200">
      <div className="col-span-2 md:col-span-1 flex items-center justify-start">
        <img
          ...
          className="hidden md:block cursor-pointer w-12 rounded-full hover:bg-gray-100 p-2"
          src="./menu.svg"
          alt="menu"
        />
        <a href="/" className="w-full">
          <img
            className="cursor-pointer w-24 md:pl-2 md:w-36"
            src="./youtube.svg"
            alt="logo"
          />
        </a>
      ...
      <div className="col-span-10 md:col-span-9 flex justify-end items-center md:block">
        <div
          className="sm:flex md:hidden sm:justify-center sm:items-center"
        ...
        <div className="hidden md:flex justify-center items-center">
          <div className="relative">
            <div className="flex justify-center items-center">
              ...
              {search !== "" && (
                <div
                  className="z-30 absolute top-2 right-[68px] font-bold text-gray-500 hover:text-gray-900 cursor-pointer"
                  onClick={() => setSearch("")}
                >
                  ╳
                </div>
              ...
              <button
                ...
                className="rounded-r-full p-2 bg-gray-100 px-4 border border-gray-200"
              >
